...
(function(root, factory) {
    ...
    var Carousel = function(element, options) {
        ...
        this.slideTo = function(next) {
            ...
            if (next < 0) { next = total - 1; } else if (next >= total) { next = 0; }
    ...
    var Collapse = function(element, options) {
        ...
        this.toggle = function(e) {
            e[preventDefault]();
            if (!hasClass(collapse, showClass)) { self.show(); } else { self.hide(); }
        };
        this.hide = function() {
    ...
    var Dropdown = function(element, option) {
        ...
        var self = this,
            ...
            dismissHandler = function(e) {
                ...
                if ((eventTarget === menu || menu[contains](eventTarget)) && (self.persist || hasData)) { return; } else {
        ...
        this.toggle = function() {
            if (hasClass(parent, showClass) && element[open]) { hide(); } else { show(); }
        };
    ...
    var Modal = function(element, options) { // element can be the modal/triggering button
        ...
        if (element) { element[stringModal] = self;
            modal[modalTrigger] = element; } else { modal[stringModal] = self; }
    };
    ...
    var Popover = function(element, options) {
        ...
        this.toggle = function() {
            if (popover === null) { self.show(); } else { self.hide(); }
        };
        this.show = function() {
            clearTimeout(timer);
    ...
    var Tooltip = function(element, options) {
        ...
        this.toggle = function() {
            if (!tooltip) { self.show(); } else { self.hide(); }
        };
